          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(
               ...
               Text('Your password reset will be send in your registered email address.', textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 14, color: ThemeColors.greyDarkerColor),),
              const SizedBox(
                height: 20,
              ),
              CustomTextButton(
